    ...
    <div class="hero">
        <div class="container">
                        ...
                        if(isset($_SESSION['cart']))
                        {
                            foreach($_SESSION['cart'] as $key=>$values)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>$values[price]<input type='hidden' value='$values[price]'></td>
                                    <td>
            ...
            <center>
                ...
                {
                    echo '<form action="../html/thanku.html" method="post"> <button name="placeorder" class="btn-btn">Place Order</button></form>';
                }
                ?>
                </center>
</body>
